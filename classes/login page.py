...
l1=Label(a,text="login form",fg="black",bg="white",font=("latin",20,"italic"))
l1.pack()
l2=Label(a,text="user name",fg="black",bg="white")
l2.place(x=100,y=150)
l3=Entry(a)
l3.place(x=200,y=150)
l4=Label(a,text="password",fg="black",bg="white")
